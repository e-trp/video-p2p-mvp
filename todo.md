...
- Done in part: the desktop GUI now exposes a local no-network demo path so the user-facing prototype can be exercised without a signaling server or second peer
